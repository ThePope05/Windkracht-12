<footer class="bottom-0 absolute w-full h-0">
    <div class="lg:flex md:flex sm:flex place-content-center lg:space-x-20 md:space-x-8 bg-dark-grey text-light xs:block">
        ...
        <div>
            <h3 class="font-bold lg:text-5xl md:text-4xl sm:text-2xl text-center">Openingstijden</h3>
            <ul class="text-center mt-2">
                ...
                <li>Vrijdag: 12:00-20:00</li>
                <li>Zaterdag: 10:00-22:00</li>
                <li>Zondag: 10:00-22:00</li>
            </ul>
        </div>
        <div>
    ...
    <div class="flex w-100vh justify-between bg-grey text-light">
        <div class="flex gap-2 items-center">
            <img class="w-10 h-10 bg-light rounded-full" src="footer-images/copyright.png" alt="">
